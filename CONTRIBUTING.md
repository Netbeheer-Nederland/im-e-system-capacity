# Contributing to im-e-system-capacity

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
im-e-system-capacity. These guidelines are not strict rules.
...
The im-e-system-capacity team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the im-e-system-capacity technical leads
...
[issues]: https://github.com/Netbeheer-Nederland/im-e-system-capacity/issues/
[pulls]: https://github.com/Netbeheer-Nederland/im-e-system-capacity/pulls/
